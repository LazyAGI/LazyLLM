...
#       - LAZYLLM_PPIO_API_KEY: the API key of PPIO (Paiou Cloud), default model "deepseek/deepseek-v3.2",
#           `source="ppio"`. You can apply for the API key at https://www.ppinfra.com/
