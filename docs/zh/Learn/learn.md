...
> 说明：
>
> 关于 `extra_keys` 字段的使用方法，详情参考[详细的接口文档](https://docs.lazyllm.ai/zh-cn/latest/API%20Reference/components/?h=extra_key#lazyllm.components.ChatPrompter)。
...
在使用时，你只需要传入用户问题作为输入，它就会返回一组与之最相关的文本片段作为输出，具体的输入输出格式会在 [5.2.2章节](#522-retriever检索) 介绍。

关于 retriever 参数的详细介绍，如果有兴趣可以参考[文档](https://docs.lazyllm.ai/zh-cn/latest/Tutorial/8/?h=retriever#retriever)。
...
![image-5.png](../assets/learn_5.png)
...
![image-6.png](../assets/learn_6.png)
...
![image-7.png](../assets/learn_7.png)
...
![image-8.png](../assets/learn_8.png)
