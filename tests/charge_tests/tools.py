...
def get_current_weather(location: str,
                        unit: Literal["Fahrenheit", "Celsius", "fahrenheit", "celsius"] = 'fahrenheit'):
    """
...
def get_n_day_weather_forecast(location: str, num_days: int,
                               unit: Literal["Fahrenheit", "Celsius", "celsius", "fahrenheit"] = 'fahrenheit'):
    """
    ...
    Args:
        ...
        unit (Literal["Fahrenheit", "Celsius", 'celsius', 'fahrenheit']):
