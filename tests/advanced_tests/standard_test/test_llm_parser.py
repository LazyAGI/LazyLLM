...
class TestLLMParser(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_node.get_text.return_value = "Hello, I am an AI robot developed by SenseTime, named LazyLLM. My mission is to assist you in building the most powerful large-scale model applications with minimal cost."
