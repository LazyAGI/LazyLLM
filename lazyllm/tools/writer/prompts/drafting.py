# flake8: noqa
GENERATE_DRAFT_SECTION_PROMPT = '''Generate a draft section from the given writing task, outline block, and writing context.
...
- The authoring carried by outline_block is the writing plan, not a list of visible headings.
- Use authoring.expected_blocks to guide coverage and ordering, but do not copy them verbatim as headings.
...
Outline block (section to draft, carries authoring):
{outline_block_json}
