...
class RerankerQueryGenerator:
    """
    Generate queries from document passages for reranker training data.
    从文档段落生成查询，用于构建 Reranker 训练数据。
    ...
    Unlike embedding training, reranker training focuses on:
    - Learning fine-grained relevance distinctions
    - Ranking quality rather than representation learning
    ...
    Args:
        ...
        difficulty_levels: Difficulty levels for queries (default: ["easy", "medium", "hard"])
    """
