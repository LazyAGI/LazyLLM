...
请以JSON格式返回结果。"""
            ...
            return """You are a professional query generation expert. Your task is to generate high-quality search queries based on the given document passage.
...
请以JSON格式返回结果。"""
            ...
            return """You are a query rewriting expert. Your task is to rewrite the given query into semantically equivalent but differently expressed forms.
...
```"""
            ...
            return f"""Rewrite the following query into {num_rewrites} different expressions while preserving the same meaning.
...
请以JSON格式返回结果。"""
            ...
            return """You are a document processing expert. Your task is to enhance the given document passage to make it more discoverable by retrieval systems.
