...
class PPIOModule(OnlineChatModuleBase):
    ...
    """
    TRAINABLE_MODEL_LIST = []  # PPIO does not support training currently
    NO_PROXY = False
    ...
    def _validate_api_key(self):
        ...
        try:
            # PPIO validates API key using a minimal chat request
            data = {
    ...
    def _chat_url(self):
        ...
        # base_url is https://api.ppinfra.com/openai
        # Need to append /chat/completions
        # Final URL: https://api.ppinfra.com/openai/chat/completions
