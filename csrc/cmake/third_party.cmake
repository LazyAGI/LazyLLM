...
if (NOT TARGET cpp_tiktoken)
    ...
    # Force static build on all platforms:
    # - Windows: tiktoken doesn't export symbols, shared build produces no import .lib (LNK1104)
    # - macOS/Linux: pcre2 (vendored inside cpp-tiktoken) must be static so delocate
    #   can package the wheel without unresolved @rpath/libpcre2-8.0.dylib references
